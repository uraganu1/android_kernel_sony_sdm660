		...
		void *context)
{
	...
	case eSAP_START_BSS_EVENT:
		...
		bss_complete->status = (eSapStatus)(*(uint8_t *)context);
	...
	case eSAP_ACS_CHANNEL_SELECTED:
		...
		if (eSAP_STATUS_SUCCESS == (eSapStatus)(*(uint8_t *)context)) {
		...
		} else if (eSAP_STATUS_FAILURE == (eSapStatus)(*(uint8_t *)context)) {
	...
	case eSAP_STA_REASSOC_EVENT:
		...
		reassoc_complete->status = (eSapStatus)(*(uint8_t *)context);
	...
	case eSAP_STA_DISASSOC_EVENT:
		...
		disassoc_comp->status = (eSapStatus)(*(uint8_t *)context);
	...
	case eSAP_STA_SET_KEY_EVENT:
		...
		key_complete->status = (eSapStatus)(*(uint8_t *)context);
